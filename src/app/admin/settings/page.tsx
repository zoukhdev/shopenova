...
export default function AdminSettings() {
  ...
  const [settings, setSettings] = useState({
    // General Settings
    siteName: 'ShopNova',
    siteDescription: 'Your Online Marketplace',
    siteUrl: 'https://eshop.com',
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400">Receive alerts when inventory is low</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        type="checkbox"
